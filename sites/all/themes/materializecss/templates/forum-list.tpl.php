 ...
 */
?>
<table id="forum-<?php print $forum_id; ?>" class="responsive-table bordered striped">
  <thead>
    <tr>
      ...
      <?php if (!$forum->is_container): ?>
        <td class="topics">
          ...
          <?php if ($forum->new_topics): ?>
            <a href="<?php print $forum->new_url; ?>" class="new"><span class="new chip"><?php print $forum->new_text; ?></a></span>
          <?php endif; ?>
        </td>
